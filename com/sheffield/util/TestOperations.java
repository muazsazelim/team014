...
public class TestOperations {
    ...
    public ArrayList getAllUsersObj(Connection connection) throws SQLException {
        try {
            ...
            while (resultSet.next()) {
                User newUser = new User(resultSet.getString("userId"), resultSet.getString("email"),resultSet.getString("password_hash"), resultSet.getInt("failed_login_attempts"), resultSet.getBoolean("account_locked"), resultSet.getString("forename"),resultSet.getString("surname"));
                System.out.println("{" +
                        "userId='" + resultSet.getString("userId") + "'" +
                        ", email='" + resultSet.getString("email") + "'" +
                        ", passwordHash='" + resultSet.getString("password_hash") + "'" +
    ...
    public User getUser(String email, Connection connection) throws SQLException {
        try {
            ...
            if (resultSet.next()) {
                User user = new User(resultSet.getString("userId"), resultSet.getString("email"),resultSet.getString("password_hash"), resultSet.getInt("failed_login_attempts"), resultSet.getBoolean("account_locked"), resultSet.getString("forename"),resultSet.getString("surname"));
                System.out.println("{" +
                        "userId='" + resultSet.getString("userId") + "'" +
                        ", email='" + resultSet.getString("email") + "'" +
                        ", passwordHash='" + resultSet.getString("password_hash") + "'" +
